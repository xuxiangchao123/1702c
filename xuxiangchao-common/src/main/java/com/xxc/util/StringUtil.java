...
public class StringUtil {
	...
	public static boolean num1(String src){
	...
	public static boolean num2(String src){
	...
	public static String randomChineseString(int length){
		...
		String arr[]={"文","良","拔","谷","父","梁","干","里","郭","门","延","归","海","舌","生","梁","丘","门","门","宫"};
		String c="";
		Random a=new Random();
		if(length==3){
			int num=(int) (Math.random()*(length-1)+1);
			for (int i = 0; i <num; i++) {
				int j = a.nextInt(arr.length);
				c+=arr[j];
			}
			return c;
		}
